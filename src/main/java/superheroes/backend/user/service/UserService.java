package superheroes.backend.user.service;

import lombok.AllArgsConstructor;
import org.modelmapper.ModelMapper;
import org.springframework.stereotype.Service;
import superheroes.backend.exception.BadRequestException;
import superheroes.backend.exception.NotFoundException;
import superheroes.backend.user.data.UserDto;
import superheroes.backend.user.entity.UserEntity;
import superheroes.backend.user.repository.UserRepository;
